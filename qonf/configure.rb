  ...
  class Configure
    ...
    def createMakefiles
      ...
      if RUBY_PLATFORM.downcase.include?("darwin")
        qmakeLine = "'CONFIG += console warn_on' 'INCLUDEPATH += /usr/local/include LIBS += -L/usr/local/lib -lavdevice -lavformat -lavfilter -lavcodec -lswresample -lswscale -lavutil -lquazip1-qt6 -lsndfile -framework CoreFoundation'"
