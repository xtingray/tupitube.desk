...
UninstallDisplayIcon={app}\tupitube.desk.exe
...
Root: HKLM; Subkey: "SYSTEM\CurrentControlSet\Control\Session Manager\Environment"; ValueType: string; ValueName: "TUPITUBE_BIN"; ValueData: "{app}"; Flags: uninsdeletevalue
